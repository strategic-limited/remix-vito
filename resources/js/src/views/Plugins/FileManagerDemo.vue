<template>
    <b-container fluid>
        <b-row>
            <b-col cols="12">
                <iq-card body-class="pt-0" id="iq-file-manager">
                        ...
                        <b-collapse id="collapse-1" class="mb-2">
                            <div class="card">
                                <kbd class="bg-dark">
                                    ...
                                    <pre class="text-white" id="Filemanager"><code>
&#x3C;template&#x3E;
    ...
    data (){
        return {
            settings: {
                ...
                baseUrl: 'http://127.0.0.1:8000/file-manager/',   // overwrite base url Axios
...
<style>
    .btn-info{
        ...
        background: -webkit-gradient(linear, left top, right top, from(var(--iq-primary)), to(var(--iq-primary-light))) !important;

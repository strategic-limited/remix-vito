        ...
        <div class="media-body">
          <div class="checkout-product-details">
            ...
            <div class="checkout-button d-flex flex-wrap align-items-center mt-4">
              <a href="#" type="submit" class="btn btn-light d-block" @click="removeToCart(item)"><i class="ri-close-line mr-1"></i>Remove</a>
              <a href="#" type="submit" class="btn btn-primary d-block ml-2" @click="addToWishlist(item)"><i class="ri-heart-line mr-1"></i>Wishlist</a>
            </div>
          </div>
        </div>
      </div>
